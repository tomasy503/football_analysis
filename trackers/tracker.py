...
class Tracker:
    ...
    def interpolate_ball_position(self, ball_positions):
        ...
        df_ball_positions = df_ball_positions.fillna(method="bfill")
    ...
    def object_detection(self, frames, read_from_stub=False, stub_path=None):
        ...
        for frame_num, detection in enumerate(detections):
            ...
            # track objects
            detection_with_track_id = self.tracker.update_with_detections(
            ...
            for frame_detection in detection_with_track_id:
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        # Draw the field to show data
        overlay = frame.copy()
        cv2.rectangle(overlay, (1350, 850), (1900, 970), (224, 224, 224), -1)
        alpha = 0.4
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for track_id, player in player_dict.items():
                color = player.get("team_color", (255, 0, 127))
